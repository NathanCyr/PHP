    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('car_manufacturer_code') ?></th>
                <th scope="col"><?= $this->Paginator->sort('car_year_of_manufacture') ?></th>
                <th scope="col"><?= $this->Paginator->sort('model') ?></th>
                <th scope="col"><?= $this->Paginator->sort('other_car_details') ?></th>
